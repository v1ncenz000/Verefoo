...
public class NetContext {
    ...
    protected void addConstraints(Optimize solver) {
        ...
        solver.Add(constraints.toArray(constr)); //adding hard constraints
        
        softConstrWildcard.forEach(t->solver.AssertSoft(t._1, WIPWILDCARD, t._2)); //adding soft constraints
    ...
    // #TODO Jalol: organize
    /**
     * This method allows to configure the IP address in a packet filter rule
     * @param packet_ip it is the packet IP address
     * @param fwIpRule is the rule IP address to configure
